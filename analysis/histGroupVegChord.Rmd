...
## Grasslands dominated by replacement fires, forests dominated by surface fires historically
Move your cursor around the diagram to explore.  Band size corresponds to proportions.
 

```{r histChord, echo=FALSE, message=FALSE, warning=FALSE, fig.height=8}
# Chord Diagram

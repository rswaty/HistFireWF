...
Pretty complete.  Needs:

* [long term-not now] recalculation of average to last 10 years (instead of last 34)
* check aestetics, e.g., font type and size, colors
* annotation either inside or outside of chart to explain 
...
```{r dumbbell, echo=FALSE, message=FALSE, warning=FALSE}
